...
# تكوين البوت
TOKEN = "8110119856:AAHeCyp8To_XhZiD-jizkvIqAgbv1_FB9Uc"
ADMIN_ID = 7251748706
...
def lummi_search(search_type, query):
    ...
    # بناء الاستعلام الصحيح حسب وثائق Lummi API
    search_query = query_map.get(search_type, "")
    if query:
    ...
    try:
        print(f"Searching Lummi API for: {search_query}")
